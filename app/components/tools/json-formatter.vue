<template>
  <div class="json-formatter">
    <div class="json-formatter__toolbar">
      ...
      <div class="json-formatter__toolbar-group">
        <button @click="formatJson" :disabled="isInputEmpty" class="btn btn-primary">
          格式化
        </button>
        <button @click="minifyJson" :disabled="isInputEmpty" class="btn btn-secondary">
          压缩
        </button>
        ...
        <div class="json-formatter__output-container">
          ...
          <div v-else-if="viewMode === 'tree' && parsedValue" class="json-formatter__tree-container">
            <div class="json-formatter__tree-actions">
              <button type="button" @click="expandAllNodes" class="btn btn-secondary">展开全部</button>
              <button type="button" @click="collapseAllNodes" class="btn btn-secondary">收起全部</button>
            </div>
    ...
    <div class="json-formatter__actions">
      ...
      <button @click="downloadJson" :disabled="!hasValidOutput" class="btn btn-secondary">
        <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
